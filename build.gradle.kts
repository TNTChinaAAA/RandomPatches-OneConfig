...
loom {
    ...
    if (project.platform.isForge) {
        forge {
            ...
            accessTransformer(file("${rootProject.projectDir}/src/main/resources/META-INF/randompatches_at.cfg"))
        }
    }
...
dependencies {
    ...
    implementation("com.github.TheRandomLabs:RandomLib:1.12-SNAPSHOT")
    shade("com.github.TheRandomLabs:RandomLib:1.12-SNAPSHOT")
...
tasks {
    ...
    named<ShadowJar>("shadowJar") {
        ...
        relocate( "com.therandomlabs.randomlib", "com.therandomlabs.randompatches.repackage.com.therandomlabs.randomlib" )
    }
